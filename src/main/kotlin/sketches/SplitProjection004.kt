package sketches.splitprojection004
...
class SplitProjection004 : Program() {
    ...
    override fun setup() {
        ...
        rt = renderTarget(width, height/2) {
            colorBuffer()
            depthBuffer()
        }
    }
...
//                drawer.perspective(10.0, width * 1.0 / (height * 0.1), 0.1, 100.0)
                ...
                drawer.projection = perspective(90.0 , width*1.0/height, 0.1, 100.0, 0.0, 0.0)
                //drawer.rotate(Vector3.UNIT_X, 90.0/(steps-1.0) * i )

                val d = 1.0
                drawer.view = transform {

                    rotate(Vector3.UNIT_X, i*90.0)
                ...
                drawer.shadeStyle = shadeStyle {
                    fragmentTransform = """
                        x_fill.rgb *=  (cos(va_position.y*30.0)*0.5+0.5);
                    """
            ...
            drawer.image(rt.colorBuffer(0), 0.0, rt.height*i*1.0)
