package sketches.splitprojection01
...
class SplitProjection001 : Program() {
...
//                drawer.perspective(10.0, width * 1.0 / (height * 0.1), 0.1, 100.0)
                ...
                drawer.shadeStyle = shadeStyle {
                    fragmentTransform = """
                        x_fill.rgb *= (v_viewNormal.y*0.5 + 0.5) * (cos(va_position.y*100.0)*0.5+0.5);
                    """
            ...
            drawer.image(rt.colorBuffer(0), -width/2.0+i*width,0.0)
